...
def send_alert(subject, body, to):
    ...
    user = 'rajputhiamsnhu0330@gmail.com'
    msg['from'] = user
    password = 'xenvdltotsszdbpc'
...
app.layout = html.Div([
    ...
    html.H2('Made by Himanshu Singh Rajput'),
...
def display_price(_, ticker_name, alert_permission, alert_value):
    fmp = FMP(output_format='pandas', api_key='5a17b2850fbd74a06aa892506093931c')
